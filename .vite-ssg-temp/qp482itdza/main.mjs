...
const _sfc_main$m = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$o, { class: "sm:hidden bg-ternary-light dark:bg-ternary-dark hover:bg-hover-light dark:hover:bg-hover-dark hover:shadow-sm px-2.5 mx-1.5 py-2 rounded-lg" }, null, _parent));
      ...
      _push(ssrRenderComponent(_sfc_main$n, { isOpen: isOpen.value }, null, _parent));
      _push(`<div class="hidden sm:flex justify-between items-center flex-col md:flex-row" data-v-27da57eb>`);
      _push(ssrRenderComponent(_sfc_main$o, { class: "ml-8 bg-primary-light dark:bg-ternary-dark px-3 py-2 shadow-sm rounded-xl cursor-pointer" }, null, _parent));
      _push(`</div></div></nav>`);
    };
  }
};
...
const AppHeader = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__scopeId", "data-v-27da57eb"]]);
const _sfc_main$l = {};
...
const FooterCopyright = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["ssrRender", _sfc_ssrRender$2]]);
const socmeds = [
  {
    id: 1,
    name: "LinkedIn",
...
const _sfc_main$j = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div>`);
      _push(ssrRenderComponent(_sfc_main$k, { class: "flex-none pt-5" }, null, _parent));
      _push(`</div></div>`);
    };
  }
};
...
const AboutMe = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["ssrRender", _sfc_ssrRender$1]]);
const _sfc_main$c = {
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$7, { contacts }, null, _parent));
      _push(`</div>`);
    };
  }
};
...
const Project = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender]]);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$2, { project: __props.project }, null, _parent));
...
const ProjectContent = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-44ac4f01"]]);
const router = [
  {
    path: "/",
    name: "home",
...
const createApp = ViteSSG(
  ...
  ({ app, router: router2, routes, isClient, initialState }) => {
    ...
    app.component("AppButton", _sfc_main$i).component("font-awesome-icon", FontAwesomeIcon);
  }
);
export {
  createApp
